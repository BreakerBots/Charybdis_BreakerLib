...
import frc.robot.BreakerLib.control.statespace.FlywheelStateSpace;
import frc.robot.BreakerLib.util.BreakerLog;
import frc.robot.BreakerLib.util.math.BreakerUnits;

/**
 * A class representing a robot's shooter flywheel and its assocated controle
 * loop
 */
public class Flywheel extends SubsystemBase {
    ...
    private FlywheelStateSpace flySS;

    public Flywheel(FlywheelConfig config, WPI_TalonFX... flywheelMotors) {
        ...
        flySS = new FlywheelStateSpace(config.getFlywheelGearing(),
