...
public class FlywheelConfig {
    ...
    public FlywheelConfig(double flywheelKp, double flywheelKi, double flywheelKd, double flywheelPosTol,
            double flywheelVelTol, double flywheelGearing, double flywheelMomentOfInertiaJulesKgMetersSquared,
