...
/** Add your docs here. */
public class MK4iSwerveModule implements GenericSwerveModule {
     ...
     */
    public MK4iSwerveModule(WPI_TalonFX driveMotor, WPI_TalonFX turnMotor, WPI_CANCoder turnEncoder,
