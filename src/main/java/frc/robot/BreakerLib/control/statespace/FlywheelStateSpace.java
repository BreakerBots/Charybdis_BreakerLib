...
public class FlywheelStateSpace extends SubsystemBase {
  ...
  public FlywheelStateSpace(double flywheelGearing, double flywheelMomentOfInertiaJulesKgMetersSquared,
