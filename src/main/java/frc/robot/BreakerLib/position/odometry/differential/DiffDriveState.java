...
public class DiffDriveState {
    ...
    public DiffDriveState(double leftDrivetrainSpeedMetersPerSecond, double rightDrivetrainSpeedMetersPerSecond,
            double leftDriveDistanceMeters, double rightDriveDistanceMeters) {
        wheelSpeeds = new DifferentialDriveWheelSpeeds(leftDrivetrainSpeedMetersPerSecond,
                rightDrivetrainSpeedMetersPerSecond);
        this.leftDriveDistanceMeters = leftDriveDistanceMeters;
        this.rightDriveDistanceMeters = rightDriveDistanceMeters;
    }

    public DiffDriveState(DifferentialDriveWheelSpeeds wheelSpeeds, double leftDriveDistanceMeters,
            double rightDriveDistanceMeters) {
