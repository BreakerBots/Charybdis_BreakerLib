...
public interface GenericOdometer {
  ...
  public abstract MovementState2d getMovementState();

  public abstract ChassisSpeeds getRobotRelativeChassisSpeeds();

  public abstract ChassisSpeeds getFieldRelativeChassisSpeeds();

  public abstract ChassisSpeeds getFieldRelativeChassisSpeeds(GenericOdometer odometer);
}
