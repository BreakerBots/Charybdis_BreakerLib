...
import frc.robot.BreakerLib.subsystemcores.drivetrain.swerve.SwerveDriveConfig;

public class SwerveDrivePoseEstimator implements GenericOdometer {
    private BreakerPigeon2 pigeon2;
    private SwerveDrivePoseEstimator poseEstimator;

    public SwerveDrivePoseEstimator(BreakerPigeon2 pigeon2, Pose2d initialPose, SwerveDriveConfig config,
