...
public class LegrangeInterpolatingTreeMap<K, V extends Interpolable<V>>
        extends java.util.AbstractMap<K, V> implements GenericInterpolatingMap<K, V> {
    private TreeMap<K, V> indexesAndValues;

    public LegrangeInterpolatingTreeMap(TreeMap<K, V> indexesAndValues) {
        this.indexesAndValues = indexesAndValues;
    }

    public LegrangeInterpolatingTreeMap() {
