...
/** Add your docs here. */
public class InterpolatingTreeMap<K, V extends Interpolable<V>> extends java.util.AbstractMap<K, V>
        implements GenericInterpolatingMap<K, V> {
    private TreeMap<K, V> indexesAndValues;

    public InterpolatingTreeMap(TreeMap<K, V> indexesAndValues) {
