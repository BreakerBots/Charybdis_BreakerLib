...
import frc.robot.BreakerLib.position.geometry.Transform3d;
import frc.robot.BreakerLib.util.selftest.DeviceHealth;

/** Photon camera */
public class PhotonCamera implements BreakerGenericDevice {
    ...
    private Transform3d cameraPositionRelativeToRobot; // Height relative to ground, all else relative to robot
                                                       // position.
     ...
     */
    public PhotonCamera(String cameraName, double verticalFOV, double horizontalFOV,
